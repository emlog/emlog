...
;(function (factory) {
    ...
    editormd.defaults = {
        ...
        watch: true,
//lang  placeholder          : "Enjoy Markdown coding now...",//"使用 Markdown 开始你的创作...",
        gotoLine: true,
        codeFold: false,
        autoHeight: false,
        autoFocus: true,
...
//lang       markdownTextarea.addClass(classNames.textarea.markdown).attr("placeholder", settings.placeholder);
...
//lang           markdownTextarea.attr("name", (settings.name !== "") ? settings.name : id + "-markdown-doc");
            }
        ...
        setToolbarHandler: function () {
            ...
            toolbarIcons.bind(editormd.mouseOrTouch("click", "touchend"), function (event) {
                ...
                if (name !== "link" && name !== "reference-link" && name !== "image" && name !== "video" && name !== "code-block" &&
    ...
    editormd.katexURL = {
        css: "../content/plugins/katex/katex.min",
        js: "../content/plugins/katex/katex.min"
    };
    ...
    editormd.dateFormat = function (format) {
        ...
        switch (format) {
            ...
            case "cn-week-day" :
            case "cn-wd" :
//lang               var cnWeekDays = ["日", "一", "二", "三", "四", "五", "六"];
//lang               datefmt = "星期" + cnWeekDays[weekDay];
//lang                break;

            case "week-day" :
            case "wd" :
//lang               var weekDays = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
//lang               datefmt = weekDays[weekDay];
