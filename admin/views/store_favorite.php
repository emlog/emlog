                    ...
                    <div class="card mb-4 shadow-sm hover-shadow-lg">
                        ...
                        <div class="card-body">
                            <p class="card-text font-weight-bold">
                                <a href="#appModal" data-toggle="modal" data-target="#appModal" data-name="<?= $v['name'] ?>" data-url="<?= $v['app_url'] ?>" data-buy-url="<?= $v['buy_url'] ?>" data-download-url="<?= $can_install ? urlencode($v['download_url']) : '' ?>" data-type="<?= $type ?>" class="h5"><?= $v['name'] ?></a>
