...
<div class="panel-heading">
    <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a class="nav-link active" href="./setting.php?action=seo"><?= _lang('setting_seo'); ?></a></li>
    ...
    <div class="card-body">
        <form action="setting.php?action=seo_save" method="post" name="seo_setting_form" id="seo_setting_form">
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="permalink0"><?= _lang('link_format_default'); ?></label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="permalink1"><?= _lang('link_format_file'); ?></label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="permalink2"><?= _lang('link_format_dir'); ?></label>
                                </div>
                            </td>
                            <td><span class="permalink_url"><?= BLOG_URL ?>post/1</span></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="permalink3"><?= _lang('link_format_category'); ?></label>
                                </div>
                            </td>
            ...
            <div class="custom-control custom-switch">
                ...
                <label class="custom-control-label" for="isalias"><?= _lang('enable_link_alias'); ?>：<span class="permalink_url"><?= BLOG_URL ?>abc</span></label>
            </div>
            <div class="custom-control custom-switch">
                <input class="custom-control-input" type="checkbox" value="y" name="isalias_html" id="isalias_html" <?= $isalias_html ?> />
                <label class="custom-control-label" for="isalias_html"><?= _lang('enable_link_alias_html'); ?>：<span class="permalink_url"><?= BLOG_URL ?>abc.html</span></label>
            </div>
            <div class="custom-control custom-switch">
                <input class="custom-control-input" type="checkbox" value="y" name="is_sample_url" id="is_sample_url" <?= $is_sample_url ?> />
                <label class="custom-control-label" for="is_sample_url"><?= _lang('enable_simple_url'); ?></label>
            </div>
            <div class="alert alert-warning mt-3">
                <?= _lang('url_rewrite_warning'); ?><br>
            </div>
            <div class="alert alert-primary">
                <p>
                    <?= _lang('nginx_rewrite_rule'); ?>：<br><br>
                    location / {<br>
            ...
            <div class="form-group">
                <label><?= _lang('site_browser_title'); ?></label>
                <input class="form-control" value="<?= $site_title ?>" name="site_title">
            </div>
            <div class="form-group">
                <label><label><?= _lang('site_keywords'); ?></label></label>
                <input class="form-control" value="<?= $site_key ?>" name="site_key">
            </div>
            <div class="form-group">
                <label><label><?= _lang('site_description'); ?></label></label>
                <textarea name="site_description" class="form-control"><?= $site_description ?></textarea>
            </div>
            <div class="form-group">
                <label><?= _lang('article_title_style'); ?></label>
                <select name="log_title_style" class="form-control">
                    <option value="0" <?= $opt0 ?>><?= _lang('article_title'); ?></option>
                    <option value="1" <?= $opt1 ?>><?= _lang('article_site_title'); ?></option>
                    <option value="2" <?= $opt2 ?>><?= _lang('article_site_browser_title'); ?></option>
                </select>
            </div>
