...
<div class="d-flex flex-column flex-sm-row justify-content-between mb-4 ml-1">
    <div class="mb-3 mb-sm-0">
        <a href="./store.php" class="badge badge-primary m-1 p-2"><?= _lang('store_recent') ?></a>
        <a href="./store.php?tag=free" class="badge badge-success m-1 p-2"><?= _lang('store_free') ?></a>
        <a href="./store.php?tag=paid" class="badge badge-warning m-1 p-2"><?= _lang('store_paid') ?></a>
        <a href="./store.php?tag=promo" class="badge badge-danger m-1 p-2"><?= _lang('store_promo') ?></a>
        <a href="./store.php?tag=download_top" class="badge badge-light text-primary p-2 small"><?= _lang('store_download_top') ?></a>
        <a href="./store.php?tag=favorite_top" class="badge badge-light text-primary p-2 small"><?= _lang('store_favorite_top') ?></a>
        <a href="./store.php?keyword=ai" class="badge badge-light text-primary p-2 small"><?= _lang('setting_ai') ?></a>
        ...
        <a href="./store.php?sid=11" class="badge badge-light text-primary p-2 small"><?= _lang('store_interaction') ?></a>
    </div>
