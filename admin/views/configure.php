...
<!--vot-->      <label><?=lang('your_timezone')?></label>
                <select name="timezone" style="width:100%;" class="form-control">
...
<!--vot-->      <?=lang('comment_interval')?> <input class="form-control" value="<?= $comment_interval ?>" name="comment_interval" style="width: 100px;"/> <?=lang('seconds')?>
            </div>
