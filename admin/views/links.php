...
<?php if (isset($_GET['error_a'])): ?>
    <div class="alert alert-danger"><?php _lang('link_required'); ?></div><?php endif ?>
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h4 mb-0 text-gray-800"><?php _lang('link'); ?></h1>
    <a href="#" class="btn btn-sm btn-success shadow-sm mt-4" data-toggle="modal" data-target="#linkModel"><i class="icofont-plus"></i> <?php _lang('add_link'); ?></a>
</div>
<form action="link.php?action=link_taxis" id="link_form" method="post">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr style="cursor: move">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <div class="align-items-center mb-3">
                                                <p class="mb-0 m-2">
                                                    ...
                                                    <?php if ($value['hide'] === 'y'): ?>
                                                        <span class="badge badge-warning"><?php _lang('hidden'); ?></span>
                                                    <?php endif ?>
                                                </p>
                                ...
                                <td>
                                    <?php if ($value['hide'] == 'n'): ?>
                                        <a href="link.php?action=hide&amp;linkid=<?= $value['id'] ?>" class="badge badge-primary"><?php _lang('hide'); ?></a>
                                    <?php else: ?>
                                        <a href="link.php?action=show&amp;linkid=<?= $value['id'] ?>" class="badge badge-warning"><?php _lang('show'); ?></a>
                                    <?php endif ?>
                                    <a href="javascript: em_confirm(<?= $value['id'] ?>, 'link', '<?= LoginAuth::genToken() ?>');" class="badge badge-danger"><?php _lang('delete'); ?></a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
    ...
    <div class="list_footer">
        <input type="submit" value="<?php _lang('save_sort'); ?>" class="btn btn-sm btn-success shadow-sm" />
    </div>
</form>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content border-0 shadow">
            <div class="modal-header border-0">
                <h5 class="modal-title" id="exampleModalLabel"><?php _lang('link'); ?></h5>
