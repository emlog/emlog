...
<!--vot--><?php if (isset($_GET['active_up'])): ?><div class="alert alert-success"><?=lang('sticked_ok')?></div><?php endif; ?>
<!--vot--><?php if (isset($_GET['active_down'])): ?><div class="alert alert-success"><?=lang('unsticked_ok')?></div><?php endif; ?>
<!--vot--><?php if (isset($_GET['error_a'])): ?><div class="alert alert-danger"><?=lang('select_post_to_operate')?></div><?php endif; ?>
<!--vot--><?php if (isset($_GET['error_b'])): ?><div class="alert alert-danger"><?=lang('select_action_to_perform')?></div><?php endif; ?>
<!--vot--><?php if (isset($_GET['active_post'])): ?><div class="alert alert-success"><?=lang('published_ok')?></div><?php endif; ?>
<!--vot--><?php if (isset($_GET['active_move'])): ?><div class="alert alert-success"><?=lang('moved_ok')?></div><?php endif; ?>
<!--vot--><?php if (isset($_GET['active_change_author'])): ?><div class="alert alert-success"><?=lang('user_modified_ok')?></div><?php endif; ?>
<!--vot--><?php if (isset($_GET['active_hide'])): ?><div class="alert alert-success"><?=lang('draft_moved_ok')?></div><?php endif; ?>
<!--vot--><?php if (isset($_GET['active_savedraft'])): ?><div class="alert alert-success"><?=lang('draft_saved_ok')?></div><?php endif; ?>
<!--vot--><?php if (isset($_GET['active_savelog'])): ?><div class="alert alert-success"><?=lang('saved_ok')?></div><?php endif; ?>
<!--vot--><?php if (isset($_GET['active_ck'])): ?><div class="alert alert-success"><?=lang('verified_ok')?></div><?php endif; ?>
<!--vot--><?php if (isset($_GET['active_unck'])): ?><div class="alert alert-success"><?=lang('rejected_ok')?></div><?php endif; ?>
...
<!--vot-->                  <th width="511" colspan="2"><b><?= lang('title') ?></b></th>
                            <?php if ($pid != 'draft'): ?>
<!--vot-->                      <th width="50" class="tdcenter"><b><?= lang('views') ?></b></th>
                            <?php endif; ?>
<!--vot-->                  <th width="100"><b><?= lang('user') ?></b></th>
<!--vot-->                  <th width="146"><b><?= lang('category') ?></b></th>
<!--vot-->                  <th width="130"><b><a href="./admin_log.php?sortDate=<?php echo $sortDate . $sorturl; ?>"><?= lang('time') ?></a></b>
                            </th>
<!--vot-->                  <th width="49" class="tdcenter"><b><a
                                            href="./admin_log.php?sortComm=<?php echo $sortComm . $sorturl; ?>"><?= lang('comments') ?></a></b></th>
<!--vot-->                  <th width="59" class="tdcenter"><b><a
                                            href="./admin_log.php?sortView=<?php echo $sortView . $sorturl; ?>"><?= lang('reads') ?></a></b></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
...
<!--vot-->                                      <a href="./admin_log.php?action=operate_log&operate=uncheck&gid=<?php echo $value['gid'] ?>&token=<?php echo LoginAuth::genToken(); ?>"><?= lang('uncheck') ?></a>
                            ...
                            <?php endforeach; else: ?>
                            <tr>
<!--vot-->                      <td class="tdcenter" colspan="8"><?= lang('yet_no_posts') ?></td>
                            </tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
