...
<!--vot-->          <textarea id="logcontent" name="logcontent"><?php echo $content; ?></textarea>
<!--vot-->          <div class="show_advset" onclick="displayToggle('advset', 1);"><?=lang('advanced_options')?><i class="icofont-simple-right"></i></div>
                <div id="advset">
