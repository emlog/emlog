...
<div class="row app-list">
    <?php foreach ($templates as $key => $value): ?>
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100 shadow-sm hover-shadow-lg" data-app-alias="<?= $value['tplfile'] ?>" data-app-version="<?= $value['version'] ?>">
...
<script>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.code === 0) {
                    ...
                    localStorage.setItem('emlog_has_template_update', (pluginsToUpdate && pluginsToUpdate.length > 0) ? '1' : '0');
    ...
    function updateTemplate(alias, $updateLink) {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.code === 0) {
                    location.href = 'template.php?action=upgrade_done';
                } else {
