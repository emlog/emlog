...
<div class="d-flex flex-column flex-sm-row justify-content-between mb-4 ml-1">
    <div class="mb-3 mb-sm-0">
        ...
        <a href="./store.php?action=plu&tag=download_top" class="badge badge-light text-primary m-1 p-2 small">下载排行榜</a>
        <a href="./store.php?action=plu&tag=paid_top" class="badge badge-light text-primary m-1 p-2 small">购买排行榜</a>
    </div>
                            ...
                            <div class="card-text d-flex justify-content-between">
                                ...
                                <div>
                                    <?php if ($v['price'] > 0): ?>
                                        ...
                                        <?php endif ?>
                                    <?php else: ?>
                                        <a href="#" class="btn btn-success installBtn" data-url="<?= urlencode($v['download_url']) ?>" data-cdn-url="<?= urlencode($v['cdn_download_url']) ?>" data-type="plugin">免费安装</a>
                                    <?php endif ?>
                                </div>
                            </div>
                        </div>
