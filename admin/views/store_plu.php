...
<div class="d-flex flex-column flex-sm-row justify-content-between mb-4 ml-1">
    <div class="mb-3 mb-sm-0">
        ...
        <a href="./store.php?action=plu&tag=free_top" class="badge badge-light text-primary m-1 p-2 small">免费排行-TOP12</a>
        <a href="./store.php?action=plu&tag=paid_top" class="badge badge-light text-primary m-1 p-2 small">付费排行-TOP12</a>
    </div>
