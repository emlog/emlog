...
<div class="d-flex flex-column flex-sm-row justify-content-between mb-4 ml-1">
    <div class="mb-3 mb-sm-0">
        ...
        <a href="./store.php?action=tpl&tag=free" class="badge badge-success m-1 p-2">仅看免费</a>
        <a href="./store.php?action=tpl&tag=paid" class="badge badge-warning m-1 p-2">仅看付费</a>
        <a href="./store.php?action=tpl&tag=promo" class="badge badge-danger m-1 p-2">限时优惠</a>
        <a href="./store.php?action=tpl&tag=download_top" class="badge badge-light text-primary m-1 p-2 small">下载排行榜</a>
        <a href="./store.php?action=tpl&tag=paid_top" class="badge badge-light text-primary m-1 p-2 small">购买排行榜</a>
    </div>
