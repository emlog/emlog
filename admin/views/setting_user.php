...
<div class="panel-heading">
    <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a class="nav-link active" href="./setting.php?action=user"><?= _lang('setting_user'); ?></a></li>
    ...
    <div class="card-body">
        <form action="setting.php?action=user_save" method="post" name="user_setting_form" id="user_setting_form">
            <div class="custom-control custom-switch">
                ...
                <label class="custom-control-label" for="is_signup"><?= _lang('enable_register'); ?></label>
            </div>
            <div class="custom-control custom-switch">
                <input class="custom-control-input" type="checkbox" value="y" name="login_code" id="login_code" <?= $conf_login_code ?>>
                <label class="custom-control-label" for="login_code"><?= _lang('login_captcha'); ?></label>
            </div>
            <div class="custom-control custom-switch">
                <input class="custom-control-input" type="checkbox" value="y" name="email_code" id="email_code" <?= $conf_email_code ?>>
                <label class="custom-control-label" for="email_code"><?= _lang('register_email_code'); ?></label>
            </div>
            <hr>
            <div class="custom-control custom-switch">
                <input class="custom-control-input" type="checkbox" value="y" name="ischkarticle" id="ischkarticle" <?= $conf_ischkarticle ?> />
                <label class="custom-control-label" for="ischkarticle"><?= _lang('register_article_audit'); ?></label>
            </div>
            <div class="custom-control custom-switch">
