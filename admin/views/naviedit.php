...
<h1 class="h4 mb-4 text-gray-800"><?php _lang('edit_navi') ?></h1>
    ...
    <div class="card-body">
        <form action="navbar.php?action=update" method="post" id="sort_new">
            ...
            <div class="form-group">
                ...
                <label for="newtab"><?php _lang('open_new_tab') ?></label>
            </div>
            <?php if ($type == Navi_Model::navitype_custom && $pid != 0): ?>
                <div class="form-group">
                    <label><?php _lang('parent_navi') ?></label>
            ...
            <input type="button" value="<?php _lang('cancel') ?>" class="btn btn-sm btn-secondary" onclick="javascript: window.history.back();" />
        </form>
    </div>
</div>
<script>
