...
<!--vot-->                          <a href="javascript: em_confirm(<?php echo $value['id']; ?>, 'navi', '<?php echo LoginAuth::genToken(); ?>');" class="badge badge-danger"><?=lang('delete')?></a>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php
...
<!--vot-->                                  <a href="javascript: em_confirm(<?php echo $val['id']; ?>, 'navi', '<?php echo LoginAuth::genToken(); ?>');" class="badge badge-danger"><?=lang('delete')?></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<!--vot-->          <div class="form-group"><input type="submit" class="btn btn-success" name="" value="<?=lang('save')?>"></div>
                <?php else: ?>
<!--vot-->          <div class="form-group"><?=lang('pages_no')?>, <a href="page_create.php"><?=lang('add_page')?></a></div>
                <?php endif; ?>
            </form>
        </div>
    </div>
