            ...
            <div class="card-body">
                ...
                <p class="card-text d-flex justify-content-between">
					<?php if (isImage($value['mimetype'])): ?>
                        <a href="javascript:insert_media_img('<?= $media_url ?>', '<?= $media_icon ?>')" title="插入到文章"><i class="icofont-plus"></i></a>
                        <a href="javascript:insert_conver('<?= $media_path ?>')" title="设为封面"><i class="icofont-image"></i></a>
