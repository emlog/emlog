...
<!--vot--><?php if (isset($_GET['active_del'])): ?><div class="alert alert-success"><?=lang('tag_delete_ok')?></div><?php endif;?>
<!--vot--><?php if (isset($_GET['active_edit'])): ?><div class="alert alert-success"><?=lang('tag_modify_ok')?></div><?php endif;?>
<!--vot--><?php if (isset($_GET['error_a'])): ?><div class="alert alert-danger"><?=lang('tag_select_to_delete')?></div><?php endif;?>
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
<!--vot--><h1 class="h3 mb-0 text-gray-800"><?=lang('tag_management')?></h1>
    </div>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
<!--vot-->  <span class="badge badge-secondary"><?=lang('tag_management')?></span>
        </div>
        <div class="card-body">
            <div>
                <?php if ($tags): ?>
