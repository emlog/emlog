...
//admin/article.php
 'drafts'		=> 'Drafts',//'草稿箱',
 '_drafts'		=> ' drafts',//'草稿箱',
 'post_manage'		=> 'Post list',//'文章管理',
 'draft_manage'		=> 'Draft management',//'草稿管理',
...
//admin/views/index.php
 ...
 'updates_no'			=> 'Already the latest version, no updates available ',//'已经是最新版本，没有可用的更新',
...
//admin/views/plugin.php
 ...
 'plugin_active_ok'		=> 'Click to activate the plug-in',//'点击开启插件',
