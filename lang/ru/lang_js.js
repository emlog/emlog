...
//admin/views/js/common.js
 'twitter_del_sure'	: 'Вы уверены, что хотите удалить данный твит?',//'你确定要删除该条微语吗？',
 'comment_del_sure'	: 'Вы уверены, что хотите удалить данный комментарий?',//'你确定要删除该评论吗？',
 'comment_ip_del_sure'	: 'Вы уверены, что хотите удалить все комментарии с данного IP?',//'你确定要删除来自该IP的所有评论吗？',
 'link_del_sure'	: 'Вы уверены, что хотите удалить данную ссылку?',//'你确定要删除该链接吗？',
 'navi_del_sure'	: 'Вы уверены, что хотите удалить данный пункт навинации?',//'你确定要删除该导航吗？',
 'backup_import_sure'	: 'Вы уверены, что хотите импортировать файл резервной копии?',//'你确定要导入该备份文件吗？',
 'attach_del_sure'	: 'Вы уверены, что хотите удалить данный файл?',//'你确定要删除该附件吗？',
 'avatar_del_sure'	: 'Вы уверены, что хотите удалить данный аватар?',//'你确定要删除头像吗？',
 'category_del_sure'	: 'Вы уверены, что хотите удалить данную категорию?',//'你确定要删除该分类吗？',
 'page_del_sure'	: 'Вы уверены, что хотите удалить данную страницу?',//'你确定要删除该页面吗？',
 'user_del_sure'	: 'Вы уверены, что хотите удалить данного пользователя?',//'你确定要删除该用户吗？',
 'template_del_sure'	: 'Вы уверены, что хотите удалить шаблон по умолчанию?',//'你确定要删除该模板吗？',
 'plugin_reset_sure'	: 'Вы уверены, что хотите восстановить настройки по умолчанию для данного плагина? При этом все ваши предыдущие настройки будут сброшены!',//'你确定要恢复组件设置到初始状态吗？这样会丢失你自定义的组件。',
 'plugin_del_sure'	: 'Вы уверены, что хотите удалить данный plugin?',//'你确定要删除该插件吗？',
