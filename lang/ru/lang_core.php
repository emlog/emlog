...
//include/lib/cache.php
 ...
 'cache_read_error'	=> 'Ошибка чтения кэша. Если сайт работает под управлением Unix/Linux, то необходимо установит права 0777 на папку "content/cache" и все внутренние подпапки. Если сайт работает под управлением Windows, необходимо добавить права на запись в этой папке для всех.',//'读取缓存失败。如果您使用的是Unix/Linux主机，请修改缓存目录 (content/cache) 下所有文件的权限为777。如果您使用的是Windows主机，请联系管理员，将该目录下所有文件设为可写',
