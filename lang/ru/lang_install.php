...
//install.php
 ...
 'php_required'		=> 'Для нормальной работы Emlog требуется PHP7 или выше (рекомендуется 7.4)',//'PHP版本太低，请使用7.0及以上版本(推荐7.4)',
 ...
 'db_name_info'		=> '(Внимание! Вы должны создать Базу Данных вручную до начала установки!)',//'The program does not automatically create a database. Please create new one)',//'(程序不会自动创建数据库，请提前创建一个空数据库或使用已有数据库)',
 ...
 'email_prompt'		=> 'Email (используется для восстановления пароля, должно быть заполнено)',//'邮箱（可用于找回密码，建议填写）',
