...
?>
<form name="form1" method="post" action="up2.2.0to2.3.0.php?action=install">
<div class="main">
<div>
<p><span class="title">emlog 2.2.0 to 2.3.0</span><span> 数据库升级程序</span></p>
</div>
<div class="b">
