...
?>
<form name="form1" method="post" action="up2.6.5to2.7.0.php?action=install">
<div class="main">
<div>
<p><span class="title">emlog 2.6.5 to 2.7.0</span><span> 数据库升级程序</span></p>
</div>
<div class="b">
