...
return [
    ...
    'smtp_user_placeholder' => 'Used for SMTP authentication, can be different from the sender\'s email address',
    'smtp_user_desc' => 'Used for SMTP login authentication, not necessarily equal to the sender\'s email; if the service provider requires a fixed user name, please fill in the user name specified by the service provider.' ,
    'smtp_password' => 'SMTP Password',
    'mail_sender_name' => 'Sender Name (Optional)',
    'smtp_server' => 'SMTP Server',
    'smtp_port_desc' => 'Port: 465/2465 for SSL, 587,2587 for STARTTLS',
    'send_test' => 'Send Test',
