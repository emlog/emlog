...
return [
    ...
    'credits' => '积分',
    'avatar' => '头像',
    'delete_avatar_btn' => '删除头像',
    'avatar_deleted_success' => '头像删除成功',
    'avatar_deleted_failed' => '头像删除失败',
    ...
    'ai_tool_wait_sensitive' => '正在执行，请稍候...',
    'ai_tool_success' => '执行成功',
    'ai_tool_no_data' => '操作成功，没有返回任何数据（这在执行 DELETE/UPDATE 时是正常的）。',
    'ai_tool_complete' => '操作执行完毕。',
    'ai_tool_failed' => '执行失败',
    'ai_tool_network_error' => '网络连接异常：',
    'ai_em_help_btn' => '询问emlog使用问题',
    ...
    'site_subtitle' => '站点副标题',
    'site_favicon' => '站点图标',
    'site_favicon_desc' => '站点浏览器标签图标（favicon），推荐使用 512×512 像素的正方形图片，支持 ICO、PNG、JPG、WEBP 格式',
    'upload_favicon_error' => '站点图标上传失败',
    'delete_favicon' => '删除站点图标',
    'site_url' => '站点地址',
    ...
    'image_prompt' => '图像描述提示词，例如：一只可爱的小猫坐在花园里',
    'size' => '尺寸',
    'image_size_placeholder' => '示例: 1024x1024, 2K',
    'image_size_tip' => '支持如 1024x1024、1792x1024 或 1.5K、2K、4K（豆包模型）等尺寸规范',
    ...
    'store_paid_top' => '🏆 购买排行',
    'store_plugin_top' => '插件热销榜',
    'store_template_top' => '主题热销榜',
    'store_active_authors' => '活跃开发者',
    'store_all_works' => '全部作品',
    ...
    'template_download_error' => '更新出错，没有购买该模版或者服务器网络问题',
    ...
    'plugin_download_error' => '更新出错，没有购买该插件或者服务器网络问题',
    ...
    'select_backup_file_desc' => '请选择emlog导出的数据库备份文件',
    'update_cache' => '更新缓存',
    ...
    'data_repair' => '数据修复',
    'data_repair_desc' => '安装并使用：工具箱插件，获得以下功能：',
    ...
    'select_operate_sort' => '请选择要操作的分类',
    'delete_link_confirm' => '删除所选友情链接？',
    'delete_sort_confirm' => '删除所选分类？',
    'delete_success' => '删除成功',
