...
<head>
    ...
    <link href="<?= TEMPLATE_URL ?>css/style.css?v=1716946996&t=<?= Option::EMLOG_VERSION_TIMESTAMP ?>" rel="stylesheet" type="text/css"/>
    <link href="<?= TEMPLATE_URL ?>css/icon/iconfont.css?t=<?= Option::EMLOG_VERSION_TIMESTAMP ?>" rel="stylesheet" type="text/css"/>
    <link href="<?= TEMPLATE_URL ?>css/markdown.css?v=1716946996&t=<?= Option::EMLOG_VERSION_TIMESTAMP ?>" rel="stylesheet" type="text/css"/>
    ...
    <script src="<?= TEMPLATE_URL ?>js/common_tpl.js?v=1716946996&t=<?= Option::EMLOG_VERSION_TIMESTAMP ?>"></script>
