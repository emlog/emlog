...
<main class="container log-con">
    ...
    <header class="log-title"><?php topflg($top); ?><?php echo $log_title; ?></header>
    <p class="date">
<!--vot--><b><?=lang('time')?>:</b> <?php echo gmdate('Y-m-d', $date); ?>&nbsp;&nbsp;&nbsp;
...
<!--vot--><b><?=lang('category')?>:</b> <?php blog_sort($logid); ?>
    ...
    <hr class="bottom-5"/>
    <article class="markdown" id="emlogEchoLog"><?php echo $log_content; ?></article>
