...
/*vot*/	$editflg = User::haveEditPermission() || $author == UID ? '<a href="' . BLOG_URL . 'admin/article.php?action=edit&gid=' . $logid . '" target="_blank">' . lang('edit') . '</a>' : '';
	echo $editflg;
}
...
<!--vot-->				<div class="comment-reply"><button class="com-reply comment-replay-btn"><?=lang('reply')?></button></div>
				</div>
			<?php else: ?>
...
<!--vot-->				<div class="comment-reply"><button class="com-reply comment-replay-btn"><?=lang('reply')?></button>
						</div><?php endif ?>
				</div>
			<?php else: ?>
				<div class="comment-infos-unGravatar">
...
<!--vot-->			<div class="cancel-reply" id="cancel-reply" style="display:none"><button class="comment-replay-btn"><?=lang('cancel_reply')?></button></div>
