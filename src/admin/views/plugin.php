...
<!--vot--><?php if (isset($_GET['error_b'])): ?><span class="alert alert-danger"><?=lang('plugin_upload_failed_nonwritable')?></span><?php endif; ?>
<!--vot--><?php if (isset($_GET['error_c'])): ?><span class="alert alert-danger"><?=lang('plugin_zip_nonsupport')?></span><?php endif; ?>
<!--vot--><?php if (isset($_GET['error_d'])): ?><span class="alert alert-danger"><?=lang('plugin_zip_select')?></span><?php endif; ?>
<!--vot--><?php if (isset($_GET['error_e'])): ?><span class="alert alert-danger"><?=lang('plugin_install_failed_wrong_format')?></span><?php endif; ?>
<!--vot--><?php if (isset($_GET['error_f'])): ?><span class="alert alert-danger"><?=lang('plugin_zipped_only')?></span><?php endif; ?>
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800"><?=lang('plugin_manage')?></h1>
...
<!--vot-->  <li style="margin:10px 0px;"><?=lang('plugin_get_more')?>:<a href="https://emlog.net/"><?=lang('app_center')?></a></li>
        </div>
    </form>
</div>
<!-- /.container-fluid -->
