...
<div class="container-fluid">
    ...
    <form action="navbar.php?action=update" method="post" id="sort_new" style="margin-top: 30px;">
        ...
        <input type="submit" value="<?=lang('_save_')?>" class="btn btn-primary" />
        <input type="button" value="<?=lang('_cancel_')?>" class="btn btn-default" onclick="javascript: window.history.back();" />
    </form>
</div>
<script>
