...
<div id="admin_style">
	...
	?>
	<div>
	<a href="./style.php?action=usestyle&style=<?php echo $style; ?>&token=<?php echo LoginAuth::genToken(); ?>" title="点击使用该风格" >
	...
	<?php endif;?>
	<a href="./style.php?action=usestyle&style=<?php echo $style; ?>&token=<?php echo LoginAuth::genToken(); ?>" title="点击使用该风格" ><?php echo $value['style_name']; ?></a> <br /><span><?php echo $value['style_author'];?></span></li>
	</div>
	<?php endforeach;?>
</div>
</form>