...
<script charset="utf-8" src="./editor/kindeditor-all-min.js?v=<?= Option::EMLOG_VERSION; ?>"></script>
<script charset="utf-8" src="./editor/lang/en.js?v=<?= Option::EMLOG_VERSION; ?>"></script>
...
<!--vot-->          <span onclick="displayToggle('FrameUpload', 0);autosave(4);" class="show_advset"><?=lang('upload_insert')?></span>
                    ...
                    <span id="asmsg"></span>
                    <input type="hidden" name="as_logid" id="as_logid" value="<?= $pageId; ?>">
                </div>
            ...
            <div>
                <textarea id="content" name="content" style="width:100%; height:460px;"><?= $content; ?></textarea>
            </div>
        </div>
    <div class=line></div>
</div>
