...
<div id="post">
<div>
    <label for="title" id="title_label"><?=lang('enter_post_title')?></label>
...
<div style="margin:10px 0px 5px 0px;">
    <label for="tag" id="tag_label"><?=lang('post_tags_separated')?></label>
    ...
    <?=lang('post_time')?>: <input maxlength="200" style="width:139px;" name="postdate" id="postdate" value="<?php echo $postDate; ?>"/>
...
<div><span id="alias_msg_hook"></span><?=lang('post_alias')?>: (<?=lang('post_alias_info')?> <a href="./seo.php" target="_blank"><?=lang('post_alias_enable')?></a>)<span id="alias_msg_hook"></span></div>
<div><input name="alias" id="alias" /></div>
<div style="margin-top:3px;">
    <?=lang('post_access_password')?>: <input type="text" value="" name="password" id="password" style="width:80px;" />
...
<div id="post_button">
    ...
    <input type="submit" value="<?=lang('post_publish')?>" onclick="return checkform();" class="button" />
    <input type="hidden" name="author" id="author" value=<?php echo UID; ?> />
    <input type="button" name="savedf" id="savedf" value="<?=lang('save_draft')?>" onclick="autosave(2);" class="button" />
</div>
</div>
</form>
<div class=line></div>
