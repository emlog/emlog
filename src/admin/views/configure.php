...
<!--vot--><label><?=lang('site_title')?>:</label><input style="width:390px;" class="form-control" value="<?php echo $blogname; ?>" name="blogname" />
        </div>
        <div class="form-group">
<!--vot--><label><?=lang('site_subtitle')?>:</label><textarea name="bloginfo" cols="" rows="3" style="width:386px;" class="form-control"><?php echo $bloginfo; ?></textarea>
        </div>
        <div class="form-group">
...
<!--vot--><label><?=lang('per_page')?>:</label><input style="width:50px;" class="form-control" value="<?php echo $index_lognum; ?>" name="index_lognum" /><?=lang('_posts')?>
        </div>
        <div class="form-group form-inline">
...
<!--vot-->  (<?=lang('local_time')?>: <?php echo date('Y-m-d H:i:s'); ?>)
        ...
        <div class="form-group">
            <div class="checkbox">
                <label>
<!--vot-->          <input type="checkbox" value="y" name="login_code" id="login_code" <?php echo $conf_login_code; ?> /><?=lang('login_verification_code')?>
                </label>
            </div>
