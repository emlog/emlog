...
<!--vot-->      <option value="n" <?= $ex2; ?>><?=lang('summary')?></option>
        ...
        <div class="form-group">
            <div class="checkbox form-inline">
<!--vot-->      <label><input type="checkbox" value="y" name="iscomment" id="iscomment" <?= $conf_iscomment; ?>><?=lang('enable_comment_interval')?><input maxlength="5" style="width:50px;"
                                                                                                                                                   class="form-control"
                                                                                                                                                   value="<?php echo $comment_interval; ?>"
                                                                                                                                                   name=comment_interval><?=lang('_seconds')?>
            </div>
            <div class="checkbox">
                <label>
...
<!--vot-->      <select name="comment_order" class="form-control">
<!--vot-->          <option value="newer" <?= $ex3; ?>><?=lang('newer')?></option>
<!--vot-->          <option value="older" <?= $ex4; ?>><?=lang('older')?></option>
...
<!--vot-->  <input maxlength="200" style="width:320px;" class="form-control" value="<?= $att_type; ?>" name="att_type"> <?=lang('allow_attach_type')?> <?=lang('separate_by_comma')?>
        ...
        <div class="form-group form-inline">
<!--vot-->  <input type="checkbox" value="y" name="isthumbnail" id="isthumbnail" <?= $conf_isthumbnail; ?>><?=lang('thumbnail_max_size')?><input maxlength="5" style="width:60px;"
                                                                                                                                          class="form-control"
                                                                                                                                          value="<?php echo $att_imgmaxw; ?>"
                                                                                                                                          name="att_imgmaxw"/> x <input maxlength="5"
                                                                                                                                                                        style="width:60px;"
                                                                                                                                                                        class="form-control"
                                                                                                                                                                        value="<?php echo $att_imgmaxh; ?>"
                                                                                                                                                                        name="att_imgmaxh"><?=lang('unit_pixels')?>
        </div>
        <div class="form-group">
<!--vot-->  <?=lang('icp_reg_no')?>:
