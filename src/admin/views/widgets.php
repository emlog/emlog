        ...
        <div class="accordion" id="accordionExample">
            <div class="card">
                <div class="card-header">
                    <h2 class="mb-0">
<!--vot-->              <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><?=lang('blogger')?></button>
...
<!--vot-->                  <li><input type="text" name="title" class="form-control" value="<?php echo $customWgTitle['blogger']; ?>"  /> <input type="submit" name="" value="<?=lang('change')?>" class="btn btn-primary btn-sm" /></li>
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="mb-0">
<!--vot-->              <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#calendar" aria-expanded="false" aria-controls="collapseTwo"><?=lang('calendar')?></button>
                        <li class="widget-act-add"></li>
                        <li class="widget-act-del"></li>
                    </h2>
                </div>
...
<!--vot-->                  <li><input type="text" name="title" class="form-control" value="<?php echo $customWgTitle['calendar']; ?>"  /> <input type="submit" name="" value="<?=lang('change')?>" class="btn btn-primary btn-sm" /></li>
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="mb-0">
<!--vot-->              <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#tag" aria-expanded="false" aria-controls="collapseThree"><?=lang('tags')?></button>
                        <li class="widget-act-add"></li>
                        <li class="widget-act-del"></li>
                    </h2>
                </div>
...
<!--vot-->                  <li><input type="text" name="title" class="form-control" value="<?php echo $customWgTitle['tag']; ?>"  /> <input type="submit" name="" value="<?=lang('change')?>" class="btn btn-primary btn-sm" /></li>
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="mb-0">
<!--vot-->              <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#sort" aria-expanded="false" aria-controls="collapseThree"><?=lang('category')?></button>
                        <li class="widget-act-add"></li>
                        <li class="widget-act-del"></li>
                    </h2>
                </div>
...
<!--vot-->                  <li><input type="text" name="title" class="form-control" value="<?php echo $customWgTitle['sort']; ?>"  /> <input type="submit" name="" value="<?=lang('change')?>" class="btn btn-primary btn-sm" /></li>
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="mb-0">
<!--vot-->              <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#archive" aria-expanded="false" aria-controls="collapseThree"><?=lang('archive')?></button>
                        <li class="widget-act-add"></li>
                        <li class="widget-act-del"></li>
                    </h2>
                </div>
...
<!--vot-->                  <li><input type="text" name="title" class="form-control" value="<?php echo $customWgTitle['archive']; ?>"  /> <input type="submit" name="" value="<?=lang('change')?>" class="btn btn-primary btn-sm" /></li>
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="mb-0">
<!--vot-->              <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#newcomm" aria-expanded="false" aria-controls="collapseThree"><?=lang('new_comments')?></button>
                        <li class="widget-act-add"></li>
                        <li class="widget-act-del"></li>
                    </h2>
                </div>
...
<!--vot-->                  <li><input class="form-control" maxlength="5" size="10" value="<?php echo Option::get('comment_subnum'); ?>" name="comment_subnum" /> <input type="submit" name="" value="<?=lang('change')?>" class="btn btn-primary btn-sm" /></li>
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="mb-0">
<!--vot-->              <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#newlog" aria-expanded="false" aria-controls="collapseThree"><?=lang('new_posts')?></button>
                        <li class="widget-act-add"></li>
                        <li class="widget-act-del"></li>
                    </h2>
                </div>
...
<!--vot-->                  <li><input class="form-control" maxlength="5" size="10" value="<?php echo Option::get('index_newlognum'); ?>" name="index_newlog" /> <input type="submit" name="" value="<?=lang('change')?>" class="btn btn-primary btn-sm" /></li>
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="mb-0">
<!--vot-->              <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#hotlog" aria-expanded="false" aria-controls="collapseThree"><?=lang('hot_posts')?></button>
                        <li class="widget-act-add"></li>
                        <li class="widget-act-del"></li>
                    </h2>
                </div>
...
<!--vot-->                  <li><input class="form-control" maxlength="5" size="10" value="<?php echo Option::get('index_hotlognum'); ?>" name="index_hotlognum" /> <input type="submit" name="" value="<?=lang('change')?>" class="btn btn-primary btn-sm" /></li>
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="mb-0">
<!--vot-->              <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#link" aria-expanded="false" aria-controls="collapseThree"><?=lang('links')?></button>
                        <li class="widget-act-add"></li>
                        <li class="widget-act-del"></li>
                    </h2>
                </div>
...
<!--vot-->                  <li><input type="text" name="title" class="form-control" value="<?php echo $customWgTitle['link']; ?>"  /> <input type="submit" name="" value="<?=lang('change')?>" class="btn btn-primary btn-sm" /></li>
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="mb-0">
<!--vot-->              <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#search" aria-expanded="false" aria-controls="collapseThree"><?=lang('search')?></button>
                        <li class="widget-act-add"></li>
                        <li class="widget-act-del"></li>
                    </h2>
                </div>
...
/*vot*/     $custom_wg_title = empty($val['title']) ? lang('widget_untitled'). ' (' . $matches[1] . ')' : $val['title'];
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="mb-0">
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#<?php echo $key; ?>" aria-expanded="true" aria-controls="collapseOne"><?php echo $custom_wg_title; ?></button>
                        <li class="widget-act-add"></li>
                        <li class="widget-act-del"></li>
                    </h2>
                </div>
...
<!--vot-->      <button type="submit" class="btn btn-primary"><?=lang('widget_add')?></button><span id="alias_msg_hook"></span>
            </form>
        </div>
    </div>
