        ...
        <div id="wrapper">
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../" target="_blank" title="<?=lang('to_site_new_window')?>">
                        <?php
                        $blog_name = Option::get('blogname');
                        echo empty($blog_name) ? lang('to_site') : subString($blog_name, 0, 24);
                        ?>
                    </a>
                </div>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li><a href="write_log.php" id="menu_wt"><i class="fa fa-edit fa-fw"></i> <?=lang('post_write')?></a></li>
                            <li><a href="admin_log.php" id="menu_log"><i class="fa fa-list-alt fa-fw"></i> <?=lang('posts')?></a></li>
                            <?php if (ROLE == ROLE_ADMIN):?>
                            <li><a href="tag.php" id="menu_tag"><i class="fa fa-tags fa-fw"></i> <?=lang('tags')?></a></li>
                            <li><a href="sort.php" id="menu_sort"><i class="fa fa-flag fa-fw"></i> <?=lang('categories')?></a></li>
                            <?php endif;?>
                            <li><a href="comment.php" id="menu_cm"><i class="fa fa-comments fa-fw"></i> <?=lang('comments')?> (
                                    <?php
                            ...
                            <li id="menu_category_view" class="">
                                ...
                                <ul class="nav nav-second-level collapse" id="menu_view">
                                    ...
                                    <li><a href="template.php" id="menu_tpl"><i class="fa fa-eye fa-fw"></i> <?=lang('templates')?></a></li>
                                </ul>
                            </li>
                            <li id="menu_category_sys" class="">
                                <a href="#"><i class="fa fa-cog fa-fw"></i> <?=lang('system')?><span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level collapse" id="menu_sys">
                                    <li><a href="./configure.php" id="menu_setting"><i class="fa fa-wrench fa-fw"></i><?=lang('settings')?></a></li>
                                    <li><a href="user.php" id="menu_user"><i class="fa fa-user fa-fw"></i> <?=lang('users')?></a></li>
                                    <li><a href="data.php" id="menu_data"><i class="fa fa-database fa-fw"></i> <?=lang('data')?></a></li>
                                    <li><a href="plugin.php" id="menu_plug"><i class="fa fa-plug fa-fw"></i> <?=lang('plugins')?></a></li>
                                    <li><a href="store.php" id="menu_store"><i class="fa fa-shopping-cart fa-fw"></i> <?=lang('applications')?></a></li>
                                </ul>
                            </li>
                            <?php if (!empty($emHooks['adm_sidebar_ext'])): ?>
                            <li id="menu_category_ext" class="">
                                <a href="#"><i class="fa fa-puzzle-piece fa-fw"></i> <?=lang('extensions')?><span class="fa arrow"></span></a>
