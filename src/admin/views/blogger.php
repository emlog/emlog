...
<div class="item_edit">
	...
	<li>邮箱<br /><input name="email" value="<?php echo $email; ?>" style="width:185px;" maxlength="200" /></li>
	...
	<li><input maxlength="200" style="width:185px;" value="<?php echo $username; ?>" name="username" /> 登陆名</li>
    <li><input type="password" maxlength="200" style="width:185px;" value="" name="newpass" /> 新密码（不小于6位，不修改请留空）</li>
	<li><input type="password" maxlength="200" style="width:185px;" value="" name="repeatpass" /> 再输入一次新密码</li>
