...
<!--vot--><li><label><?=lang('nickname')?></label><input maxlength="50" style="width:200px;" class="form-control" value="<?php echo $nickname; ?>" name="name" /> </li>
<!--vot--><li><label><?=lang('email')?></label><input name="email" class="form-control" value="<?php echo $email; ?>" style="width:200px;" maxlength="200" /></li>
<!--vot--><li><label><?=lang('personal_description')?></label><textarea name="description" class="form-control" style="width:300px; height:65px;" type="text" maxlength="500"><?php echo $description; ?></textarea></li>
<!--vot--><li><label><?=lang('login_name')?></label><input maxlength="200" style="width:200px;" class="form-control" value="<?php echo $username; ?>" name="username" /></li>
