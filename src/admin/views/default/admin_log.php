...
<form action="admin_log.php?action=operate_log" method="post" name="form_log" id="form_log">
  ...
  <thead>
	...
	$sortName = $value['sortid'] == -1 && !array_key_exists($value['sortid'], $sort_cache) ? $lang['unclassified'] : $sort_cache[$value['sortid']]['sortname'];
...
<div class="page"><?php echo $pageurl; ?> (<? echo $lang['with'];?> <?php echo $logNum; ?> <? echo $lang['items'];?> <?php echo $pid == 'draft' ? $lang['draft'] : $lang['posts']; ?>)<?php echo $pageurl; ?></div>
<script>
