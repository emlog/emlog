...
<div style="margin:0px 0px 20px 3px;"><a href="javascript:$('#backup').toggle();void(0);">备份数据&raquo;</a></div>
...
<table width="95%" align="center" border="0" cellspacing="1" cellpadding="4" class="formtd2">
   <tr>
   <td class="notice">
   缓存技术可以大幅度加快你博客首页的加载速度。<br>通常系统会自动更新缓存，但也有些特殊情况需要你手动更新，比如缓存文件被无意修改、你手动修改过数据库 等。
   </td>
  </tr>
<tr><td><input name="" type="button" onclick="window.location='data.php?action=mkcache';" value="重建缓存" class="submit" /></td></tr>  
</table>