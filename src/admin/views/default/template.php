...
<table cellspacing="10" cellpadding="0" width="80%" border="0">
    <tr>
      <td width="27%">
	  <img src="<?php echo $tpl_dir.$nonce_templet; ?>/preview.jpg" width="300" height="225"  border="1" />	  </td>
	  <td width="73%">
	  <?php echo $tplName; ?><br>
...
?>
	  ...
	  <img alt="点击使用该模板" src="<?php echo $tpl_dir; ?><?php echo $value['tplfile']; ?>/preview.jpg" width="180" height="150" border="0" />
	  </a><br />
