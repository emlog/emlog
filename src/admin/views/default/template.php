...
<table cellspacing="10" cellpadding="0" width="80%" border="0">
    <tr>
      <td width="27%">
	  <img src="<?php echo TEMPLATE_PATCH.$nonce_templet; ?>/preview.jpg" width="300" height="225"  border="1" />	  </td>
	  <td width="73%">
	  <?php echo $tplName; ?><br>
...
<div class=line><span class="care" style="padding:0px 12px;">当前共有<?php echo $tplnums; ?>个可用模板 <a href="http://www.emlog.net/template/" target="_blank">获取更多模板&raquo;</a></span></div>
...
?>
	  ...
	  <img alt="点击使用该模板" src="<?php echo TEMPLATE_PATCH.$value['tplfile']; ?>/preview.jpg" width="180" height="150" border="0" />
	  </a><br />
