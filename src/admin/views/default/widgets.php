...
<div id="adm_widget_list">
	...
	<div class="widget-line" id="blogger">
		...
		<div class="widget-control">
			...
			<li><a href="blogger.php"><? echo $lang['widget_blogger_info'];?></a></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="newlog">
		...
		<div class="widget-control">
			...
			<li><input maxlength="5" size="10" value="<?php echo $index_newlognum; ?>" name="index_newlog" /> <input type="submit" name="" value="<? echo $lang['widget_change'];?>" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="random_log">
		...
		<div class="widget-control">
			...
			<li><input maxlength="5" size="10" value="<?php echo $index_randlognum; ?>" name="index_randlognum" /> <input type="submit" name="" value="<? echo $lang['widget_change'];?>" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="music">
		<div class="widget-top">
			<li class="widget-title"><? echo $lang['music'];?></li>
			<li class="widget-act-add"> </li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			...
			<li><? echo $lang['music_links'];?></li>
			<li>(<? echo $lang['music_links_info'];?>)</li>
			<li><textarea name="mlinks" rows="6" wrap="off" style="width:350px;overflow:auto;"><?php echo $content; ?></textarea></li>
			<li><? echo $lang['music_random'];?>:
		      <input type="radio" value="1" name="randplay" <?php echo $randplay1; ?>/><? echo $lang['yes'];?>
			  <input type="radio" value="0" name="randplay" <?php echo $randplay2; ?>/><? echo $lang['no'];?>
			</li>
			<li><? echo $lang['music_autoplay'];?>:
		      <input type="radio" value="1" name="auto" <?php echo $auto1; ?>/><? echo $lang['yes'];?>
			  <input type="radio" value="0" name="auto" <?php echo $auto2; ?>/><? echo $lang['no'];?>
			</li>
			<li><input type="submit" value="<? echo $lang['music_submit'];?>" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="bloginfo">
		<div class="widget-top">
			<li class="widget-title"><? echo $lang['blog_statistics'];?></li>
			<li class="widget-act-add"></li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			<li><? echo $lang['title'];?></li>
			<li><input type="text" name="title" value="<?php echo $customWgTitle['bloginfo']; ?>"  /> <input type="submit" name="" value="<? echo $lang['widget_change'];?>" class="submit" /></li>
		</div>
	</div>
	...
	$custom_wg_title = empty($val['title']) ? '<? echo ;?> ('.$matches[1].')' : $val['title'];
	?>
