...
<div style="margin-top: 5px;">
    ...
    <input name="alias" id="alias" value="<?php echo $alias; ?>" class="form-control" />
</div>
<div style="margin-top:3px;">
    页面模板：<input maxlength="200" class="form-control" name="template" id="template" value="<?php echo $template;?>" /> （用于自定义页面模板，对应模板目录下.php文件）
