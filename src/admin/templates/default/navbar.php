...
<!--vot-->    <a href="navbar.php?action=show&amp;id=<?= $value['id'] ?>" title="<?=lang('nav_show_click')?>" style="color:red;"><?=lang('hide')?></a>
        ...
        <img src="./views/<?php echo ADMIN_TEMPLATE; ?>/images/<?= $value['newtab'] == 'y' ? 'vlog.gif' : 'vlog2.gif' ?>" align="absbottom" border="0"></a>
        </td>
        <td><?= $value['url'] ?></td>
        <td>
...
<!--vot-->    <a href="navbar.php?action=show&amp;id=<?= $val['id'] ?>" title="<?=lang('nav_show_click')?>" style="color:red;"><?=lang('hide')?></a>
        ...
        <img src="./views/<?php echo ADMIN_TEMPLATE; ?>/images/<?= $val['newtab'] == 'y' ? 'vlog.gif' : 'vlog2.gif' ?>" align="absbottom" border="0"></a>
        </td>
        <td><?= $val['url'] ?></td>
        <td>
