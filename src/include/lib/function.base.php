...
function emoFormat($t){
	$emos = array( "[草泥马]"=>"0.gif", "[神马]"=>"1.gif", "[浮云]"=>"2.gif", "[给力]"=>"3.gif", "[围观]"=>"4.gif", "[威武]"=>"5.gif", "[熊猫]"=>"6.gif", "[兔子]"=>"7.gif", "[奥特曼]"=>"8.gif", "[囧]"=>"9.gif", "[互粉]"=>"10.gif", "[礼物]"=>"11.gif", "[呵呵]"=>"12.gif", "[嘻嘻]"=>"13.gif", "[哈哈]"=>"14.gif", "[可爱]"=>"15.gif", "[可怜]"=>"16.gif", "[挖鼻屎]"=>"17.gif", "[吃惊]"=>"18.gif", "[害羞]"=>"19.gif", "[挤眼]"=>"20.gif", "[闭嘴]"=>"21.gif", "[鄙视]"=>"22.gif", "[爱你]"=>"23.gif", "[泪]"=>"24.gif", "[偷笑]"=>"25.gif", "[亲亲]"=>"26.gif", "[生病]"=>"27.gif", "[太开心]"=>"28.gif", "[懒得理你]"=>"29.gif", "[右哼哼]"=>"30.gif", "[左哼哼]"=>"31.gif", "[嘘]"=>"32.gif", "[衰]"=>"33.gif", "[委屈]"=>"34.gif", "[吐]"=>"35.gif");
