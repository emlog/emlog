...
function emoFormat($t){
	$emos = array( "[草泥马]"=>"0.gif", "[神马]"=>"1.gif", "[浮云]"=>"2.gif", "[给力]"=>"3.gif", "[围观]"=>"4.gif", "[威武]"=>"5.gif", "[熊猫]"=>"6.gif", "[兔子]"=>"7.gif", "[奥特曼]"=>"8.gif", "[囧]"=>"9.gif", "[互粉]"=>"10.gif", "[礼物]"=>"11.gif", "[呵呵]"=>"12.gif", "[嘻嘻]"=>"13.gif", "[哈哈]"=>"14.gif", "[可爱]"=>"15.gif", "[可怜]"=>"16.gif", "[挖鼻屎]"=>"17.gif", "[吃惊]"=>"18.gif", "[害羞]"=>"19.gif", "[挤眼]"=>"20.gif", "[闭嘴]"=>"21.gif", "[鄙视]"=>"22.gif", "[爱你]"=>"23.gif", "[泪]"=>"24.gif", "[偷笑]"=>"25.gif", "[亲亲]"=>"26.gif", "[生病]"=>"27.gif", "[太开心]"=>"28.gif", "[懒得理你]"=>"29.gif", "[右哼哼]"=>"30.gif", "[左哼哼]"=>"31.gif", "[嘘]"=>"32.gif", "[衰]"=>"33.gif", "[委屈]"=>"34.gif", "[吐]"=>"35.gif", "[打哈欠]"=>"36.gif", "[抱抱]"=>"37.gif", "[怒]"=>"38.gif", "[疑问]"=>"39.gif", "[馋嘴]"=>"40.gif", "[拜拜]"=>"41.gif", "[思考]"=>"42.gif", "[汗]"=>"43.gif", "[困]"=>"44.gif", "[睡觉]"=>"45.gif", "[钱]"=>"46.gif", "[失望]"=>"47.gif", "[酷]"=>"48.gif", "[花心]"=>"49.gif", "[哼]"=>"50.gif", "[鼓掌]"=>"51.gif", "[晕]"=>"52.gif", "[悲伤]"=>"53.gif", "[抓狂]"=>"54.gif", "[黑线]"=>"55.gif", "[阴险]"=>"56.gif", "[怒骂]"=>"57.gif", "[心]"=>"58.gif", "[伤心]"=>"59.gif", "[猪头]"=>"60.gif", "[ok]"=>"61.gif", "[耶]"=>"62.gif", "[good]"=>"63.gif", "[不要]"=>"64.gif", "[赞]"=>"65.gif", "[来]"=>"66.gif", "[弱]"=>"67.gif", "[蜡烛]"=>"68.gif", "[钟]"=>"69.gif", "[话筒]"=>"70.gif", "[蛋糕]"=>"71.gif", "[笑哈哈]"=>"72.gif", "[得意地笑]"=>"73.gif", "[转发]"=>"74.gif");
	if(!empty($t) && preg_match_all('/\[.+?\]/',$t,$matches)){
		$matches = array_unique($matches[0]);
		foreach ($matches as $data) {
			$t = str_replace($data,'<img title="'.$data.'" src="'.BLOG_URL.'/admin/views/emo/'.$emos[$data].'"/>',$t);
		}
	}
	return $t;
}
