...
class Dispatcher {
	...
	private function __construct() {
		...
		doAction('before_parse_url', $this->_routingTable, $urlMode);
		...
		doAction('after_parse_url', $this->_model, $this->_method, $this->_params);
