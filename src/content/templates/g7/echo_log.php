...
<?php if($allow_tb == 'y'): ?>	
	...
	<h2 id="comments">引用：<input type="text" style="width:350px" value="<?php echo $blogurl;?>tb.php?sc=<?php echo $tbscode;?>&amp;id=<?php echo $logid;?>" size="40" id="email"/><a name="tb"></a></h2>
	</div>
<?php endif; ?>	
</div>
