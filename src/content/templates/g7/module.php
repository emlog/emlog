...
function widget_sort($title){
	...
	<a href="<?php echo BLOG_URL; ?>rss.php?sort=<?php echo $value['sid']; ?>"><img align="absmiddle" src="<?php echo CERTEMPLATE_URL; ?>/images/rss_f.png" alt="订阅该分类"/></a>
	</li>
	<?php endforeach; ?>	
	</ul>
	</li>
...
function blog_trackback(){
	...
	<?php if($allow_tb == 'y'): ?>	
		...
		<h2 id="comments">引用：<input type="text" style="width:350px" value="<?php echo BLOG_URL;?>tb.php?sc=<?php echo $tbscode;?>&amp;id=<?php echo $logid;?>" size="40" id="email"/><a name="tb"></a></h2>
		</div>
	<?php endif; ?>	
