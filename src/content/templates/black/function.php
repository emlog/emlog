...
<?php function widget_blogger($title){ ?>
	...
	<ul class="pagenav"><h2 onclick="showhidediv('blogger')"><?php echo $title; ?></h2>
	<ul id="blogger">
		<p><?php echo $photo;?></p>
		<p><b><?php echo $name;?></b>
...
<?php function widget_calendar($title){ ?>
	...
	<ul class="categories"><h2 onclick="showhidediv('cal')"><?php echo $title; ?></h2>
	<ul id="cal">
	<div id="calendar"></div>
	</ul>
	</ul>
...
<?php function widget_tag($title){ ?>
	...
	<ul class="blogtags"><h2 onclick="showhidediv('blogtags')"><?php echo $title; ?></h2>
	<ul id="blogtags">
	<li>
...
<?php function widget_sort($title){ ?>
	...
	<ul class="logsort"><h2 onclick="showhidediv('logsort')"><?php echo $title; ?></h2>
	<ul id="logsort">
...
<?php function widget_twitter($title){ ?>
	...
	<ul class="r_comments"><h2 onclick="showhidediv('twitter')"><?php echo $title; ?></h2>
	<ul id="twitter">
	<?php  
...
<?php function widget_music($title){ ?>
	...
	<ul class="some"><h2 onclick="showhidediv('music')"><?php echo $title; ?></h2>
	<ul id="music">
...
<?php function widget_newcomm($title){ ?>
	...
	<ul class="r_comments"><h2 onclick="showhidediv('comm')"><?php echo $title; ?></h2>
	<ul id="comm">
...
<?php function widget_newlog($title){ ?>
	...
	<ul class="newlog"><h2 onclick="showhidediv('newlog')"><?php echo $title; ?></h2>
	<ul id="newlog">
...
<?php function widget_random_log($title){ ?>
	...
	?>
	<ul class="randlog"><h2 onclick="showhidediv('randlog')"><?php echo $title; ?></h2>
	<ul id="randlog">
...
<?php function widget_archive($title){ ?>
	...
	<ul class="archives"><h2 onclick="showhidediv('dang')"><?php echo $title; ?></h2>
	<ul id="dang">
...
<?php function widget_custom_text($title, $content, $id){ ?>
	<ul class="custom"><h2 onclick="showhidediv('custom<?php echo $id; ?>')"><?php echo $title; ?></h2>
...
<?php function widget_link($title){ ?>
	...
	<ul class="random"><h2 onclick="showhidediv('links')"><?php echo $title; ?></h2>
	<ul id="links">
...
<?php function widget_bloginfo($title){ ?>
	...
	<ul class="statistics"><h2 onclick="showhidediv('sta')"><?php echo $title; ?></h2>
		<ul id="sta">
