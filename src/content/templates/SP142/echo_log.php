                ...
                <div class="post-top">
                    <div class="post-title">
                    	<h2><?php echo $log_title; ?></h2>
						 <h3><?php if($log_cache_sort[$logid]): ?>
<span class="sort">Filed Under [<a href="<?php echo BLOG_URL; ?>?sort=<?php echo $sortid; ?>"><?php echo $log_cache_sort[$logid]; ?></a>]</span>
<?php endif;?> on <?php echo date('Y-n-j G:i l', $date); ?>                        </h3>
						                    </div>
                </div>
