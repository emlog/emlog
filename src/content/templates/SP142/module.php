...
function widget_blogger($title){
	...
	<ul style="text-align:center" id="bloggerinfo">
		<li><?php if (!empty($user_cache[1]['photo']['src'])): ?>
		...
		<img style="border:0; background:0; padding:0;"src="<?php echo CERTEMPLATE_URL; ?>/images/modify.gif" align="absmiddle" alt="修改我的状态"/></a></li>
...
function blog_sort($sort, $blogid){
	...
	Filed Under <a href="./?sort=<?php echo $sort; ?>"><?php echo $log_cache_sort[$blogid]; ?></a>
	<?php endif;?>
<?php }?>
<?php
//blog：文件附件
