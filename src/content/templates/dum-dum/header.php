...
<div class="menu2">
<ul>
	<li class="nocurrent_page_item"><a href="./">首页</a></li>
	...
	<li class="nocurrent_page_item"><a href="./admin/?action=logout">退出</a></li>
	<?php else: ?>
	<li class="nocurrent_page_item"><a href="./admin/">登录</a></li>
	<?php endif; ?>
</ul>
</div>
</div>
