...
function widget_calendar($title){
	global $calendar_url; ?>
	<li class="categories"><h4 onclick="showhidediv('cal')"><?php echo $title; ?></h4>
	<ul id="cal">
	<div id="calendar"></div>
	</ul>
	</li>
...
function widget_tag($title){
	global $tag_cache; ?>
	<h4 onclick="showhidediv('blogtags')"><?php echo $title; ?></h4>
	<ul id="blogtags">
	<li>
	<?php foreach($tag_cache as $value): ?>
		<span style="font-size:<?php echo $value['fontsize']; ?>px; height:30px;">
...
function widget_sort($title){
	global $sort_cache; ?>
	<li class="logsort"><h4 onclick="showhidediv('logsort')"><?php echo $title; ?></h4>
	<ul id="logsort">
...
function widget_twitter($title){
	...
	<li class="r_comments"><h4 onclick="showhidediv('twitter')"><?php echo $title; ?></h4>
	<ul id="twitter">
	<?php  
...
function widget_newcomm($title){
	global $com_cache; ?>
	<li class="r_comments"><h4 onclick="showhidediv('comm')"><?php echo $title; ?></h4>
	<ul id="comm">
	<?php 
...
function widget_newlog($title){
	...
	<li class="newlog"><h4 onclick="showhidediv('newlog')"><?php echo $title; ?></h4>
	<ul id="newlog">
...
function widget_random_log($title){
	...
	<li class="randlog"><h4 onclick="showhidediv('randlog')"><?php echo $title; ?></h4>
	<ul id="randlog">
...
function widget_archive($title){
	global $dang_cache; ?>
	<li class="archives"><h4 onclick="showhidediv('dang')"><?php echo $title; ?></h4>
	<ul id="dang">
...
function widget_custom_text($title, $content, $id){ ?>
	<li class="custom"><h4 onclick="showhidediv('<?php echo $id; ?>')"><?php echo $title; ?></h4>
	<ul id="<?php echo $id; ?>">
...
function widget_search($title){ ?>
	<li class="logserch"><h4 onclick="showhidediv('logserch')"><?php echo $title; ?></h4>
	<ul id="logserch">
	<li>
...
function widget_link($title){
	global $link_cache; ?>
	<li class="random"><h4 onclick="showhidediv('links')"><?php echo $title; ?></h4>
	<ul id="links">
...
function widget_bloginfo($title){
	...
	<li class="statistics"><h4 onclick="showhidediv('sta')"><?php echo $title; ?></h4>
		<ul id="sta">
...
function blog_comments(){
	...
	<?php echo $value['content'];?>	<br /><br /><div id="replycomm<?php echo $value['cid']; ?>"><?php echo $reply;?></div>
		<?php if(ISLOGIN === true): ?>	
