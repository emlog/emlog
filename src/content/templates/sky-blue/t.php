...
<div id="content">
	<div id="tw">
    	...
    	<div class="post">
    		...
    		<div class="clear"></div>
    		<div class="bttome">
        		<p class="reply"><a href="javascript:loadr('<?php echo DYNAMIC_BLOGURL; ?>?action=getr&tid=<?php echo $tid;?>','<?php echo $tid;?>');">回复(<span id="rn_<?php echo $tid;?>"><?php echo $val['replynum'];?></span>)</a></p>
    ...
    <div class="top_post"></div>
    	<div class="post">
    		<div class="entry"><div class="pagenavi"><?php echo $pageurl;?></div></div>
    	</div>
    <div class="bottom_post"></div>
</div>
