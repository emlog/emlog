...
// 'image_attachment_thumbnails'	=> '图片附件缩略图',//'Image Attachment thumbnails',
...
//// 'backup_format_supported'	=> '(支持emlog导出的sql及zip格式备份)',//'(supports emlog backup exported to sql and zip format)',
//// 'data_cache'		=> '数据缓存',//'Data Cache',
...
// '_twitters'			=> '条微语',//' twitters',
 ...
 'official_source'		=> '官方消息',//'Official sources',
...
// 'save_settings'		=> '缓存更新成功保存设置',//'Save Settings',

//---------------------------
//admin/views/store.php
// 'app_center'		=> '应用中心',//'App center',
...
// 'admin'			=> '管理员',//'Administrator',
// 'posts_not_need_audit'	=> '文章不需要审核',//'Posts not need to be verified',
// 'posts_need_audit'		=> '文章需要审核',//'Posts that need to be verified',
// 'personal_description'	=> '个人描述',//'Personal Description',
// 'save'			=> '保 存',//'Save',
// 'cancel'			=> '取 消',//'Cancel',
