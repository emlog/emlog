...
$lang['db_not_found']	= 'Failed to connect to the database, the database you filled in was not found';//'连接数据库失败，未找到您填写的数据库';
...
$lang['db_no_name']	= 'Failed to connect to the database, please fill in the database name';//'连接数据库失败，请填写数据库名';
...
$lang['category_choose']	= 'Choose Category';//选择 分类...
...
$lang['_pending_articles']	= ' pending articles';//'篇文章待审';
...
$lang['plugin_setup_click']	= 'Click to set up the plugin';//'点击设置插件';
$lang['article_review_ok']	= 'The article was successfully reviewed';//'文章审核成功';
$lang['article_reject_ok']	= 'The article was successfully rejected';//'文章驳回成功';
$lang['reject']			= 'Reject';//'审核';
$lang['nickname_allready_exists'] = 'The nickname already exists';//'该昵称已存在';
$lang['summary_auto']		= 'Automatic summary, get it from the article beginning';//'自动摘要，截取文章的前';
$lang['summary_prompt']		= 'Some words for a summary';//'个字作为摘要';
$lang['mobile_address']		= 'Mobile version address';//'手机访问版，地址';
$lang['app_dir_not_writable']	= 'Installation failed, may be the application directory is not writable';//'安装失败，可能是应用目录不可写';
$lang['emlog_using']		= 'You are using emlog';//'您正在使用emlog';
$lang['check_update']		= 'Check for updates';//'检查更新';
$lang['_articles']		= ' articles';//'篇文章';

$lang['page_template']		= 'Page template';//'页面模板';
$lang['page_template_file']	= '(Corresponding to the .php file in the template directory)';//'（对应模板目录下.php文件）';
$lang['category_top']		= 'Top category';//'分类置顶';
$lang['attachment_max_upload']	= 'Maximum attachment upload limit';//'附件上传最大限制';
$lang['attachment_php_info']	= 'Uploaded files are also subject to the server PHP configuration maximum upload';//'上传文件还受到服务器PHP配置最大上传';
$lang['limit']			= '';//!!! Leave empty! for non-Chinese//'限制';
$lang['separate_by_comma']	= 'Separate multiple values by commas';//'多个用半角逗号分隔';
$lang['thumbnail_generate']	= 'Generate thumbnail for uploaded image';//'上传图片生成缩略图';
$lang['max_size']		= 'Max size';//'最大尺寸';
$lang['unit_pixel']		= '(Unit: pixel)';//'（单位：像素）';
$lang['apps']			= 'Applications';//'应用';
$lang['template_log_list']	= '(Used to customize the category page template, the default is the log_list.php file in the template directory)';//'(用于自定义分类页面模板，默认为模板目录下log_list.php文件)';
$lang['article_top_home']	= 'Top article on homepage';//'首页置顶文章';
$lang['article_top_category']	= 'Top article on category';//'分类置顶文章';

$lang['view_by_category']	= 'View by category';//'按分类查看';
$lang['sticy_action']		= 'Sticky operation';'置顶操作';
$lang['top_home']		= 'Home top';//'首页置顶';
$lang['nav_parent']		= 'Parent navigation';//'父导航';
$lang['mysqli_not_support']	= 'Server PHP does not support MySqli functions';//'服务器PHP不支持MySqli函数';

$lang['view_by_author']		= 'View by author';//'按作者查看';
$lang['view_by_tag']		= 'View by tag';//'按标签查看';
$lang['backup_version_prefix']	= 'Only the database backup files exported by the same version of emlog can be imported, and the prefixes of the database tables must be consistent.';//'仅可导入相同版本emlog导出的数据库备份文件，且数据库表前缀需保持一致。';
$lang['db_prefix_current']	= 'Current database table prefix';//'当前数据库表前缀';
$lang['cache_explain']		= 'Caching can speed up the loading speed of the site. Usually the system will automatically update the cache, no need to manually. Some special situations, such as cache files being modified, manual modification of the database, page exceptions, etc., need to be manually updated.';//'缓存可以加快站点的加载速度。通常系统会自动更新缓存，无需手动。有些特殊情况，比如缓存文件被修改、手动修改过数据库、页面出现异常等才需要手动更新。';
