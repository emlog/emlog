...
$lang['reply_captcha_ebable']	= '开启回复验证码';//'Enable captcha on reply';
...
$lang['twitter_enable']		= '开启碎语';//'Enable Twitter';
$lang['upload_insert']		= '上传和插入';//'Upload and insert';
...
$lang['alias_prompt']		= '别名 (用于URL的友好显示)';//'Alias (used for friendly display of URLs)';
$lang['no_tags_yet']		= '还没有标签，写日志的时候可以给日志打标签';//'No tags yet. You can add tags when writing the post';
