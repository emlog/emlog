...
$lang['management'] = '博客管理';//'Blog Management';
...
$lang['attachment_exceed_system_limit'] = '附件大小超过系统限制限制 ';//'Attachment size exceeds the system limit ';
...
$lang['pages']			= '个页面';//' pages';// number of!
...
$lang['reference_notice']	= '引用通告';//'Reference notice';
...
$lang['posts_and_output']	= '篇日志，且输出';//' posts, and output ';
$lang['full text']		= '全文';//'Full text';
$lang['author_avatar']		= '评论人头像';//'Commenter Avatar';
...
$lang['top_image_customize']	= '自定义顶部图片';//'Customize the top image';
$lang['template_library']	= '模板库';//'Template library';
...
$lang['template_upload_zip']	= '请选择一个zip模板安装包';//'Please select a zip template installation package';
