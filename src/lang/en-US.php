...
$lang['comments_disabled'] = 'Add Comment Failed. Comments for this Blog disabled.';//'发表评论失败：该日志已关闭评论';
$lang['comment_allready_exists'] = 'Failed to post a comment: A Comment with the same content already exists.';//'发表评论失败：已存在相同内容评论';
