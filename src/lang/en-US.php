...
$lang['reply_captcha_ebable']	= 'Enable captcha on reply';//'开启回复验证码';
...
$lang['twitter_enable']		= 'Enable Twitter';//'开启碎语';
$lang['upload_insert']		= 'Upload and insert';//'上传和插入';
...
$lang['alias_prompt']		= 'Alias (used for friendly display of URLs)';//'别名 (用于URL的友好显示)';
$lang['no_tags_yet']		= 'No tags yet. You can add tags when writing the post';//'还没有标签，写日志的时候可以给日志打标签';
