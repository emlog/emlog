...
$lang['backup_bad_format']	= 'Import failed! The backup file is not a emlog backup file! ';//'导入失败! 该备份文件不是 emlog 的备份文件!';
...
$lang['backup_not_readable']	= 'Import failed! Can not read backup file! ';//'导入失败! 备份文件无法读取!';
...
$lang['photo'] = 'Photo';//头像
$lang['photo_info'] = 'Avatar (recommended to upload a jpg or png image with a size of 120X120)';//头像 (推荐上传大小为 120X120 的jpg或png图片)
...
$lang['attachment_exceed_system_limit'] = 'Attachment size exceeds the system limit ';//'附件大小超过系统限制限制 ';
...
$lang['comment_posted_premod'] = 'Your comment was saved successfully! Please wait for the administrator review and approve it!';
...
$lang['reference_notice']	= 'Reference notice';//'引用通告';
...
$lang['top_image_customize']	= 'Customize the top image';//'自定义顶部图片';
$lang['template_library']	= 'Template library';//'模板库';
...
$lang['template_upload_zip']	= 'Please select a zip template installation package';//'请选择一个zip模板安装包';
