...
<div class="contentA">
	...
	<img src="<?php echo $tpl_dir; ?>heart/images/modify.gif" align="absmiddle" alt="修改我的状态"/></a></li>
...
?>
<span style="font-size:<?php echo $value['fontsize'];?>pt; height:30px;"><a href="index.php?tag=<?php echo $value['tagurl']; ?>" style="color:#00ccff"><?php echo $value['tagname']; ?></a></span>&nbsp;
<?php endforeach; ?>
</li></ul>
...
<?php foreach($com_cache as $value): ?>
	...
	<img src="<?php echo $tpl_dir; ?>heart/images/reply.gif" align="absmiddle"/>
	</a>
	<?php endif;?>
