...
?>
<span style="font-size:<?php echo $value['fontsize']; ?>px; height:30px;"><a href="index.php?tag=<?php echo $value['tagurl']; ?>" style="color:#00ccff"><?php echo $value['tagname']; ?></a></span>&nbsp;
<?php endforeach; ?>
</li></ul>
