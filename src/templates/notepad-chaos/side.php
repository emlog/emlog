...
<div class="categories">
  <ul>
	...
	<?php if($value['reply']): ?>
	<img src="<?php echo $tpl_dir; ?>default/images/reply.gif" style="border:0" title="博主回复：<?php echo $value['reply']; ?>"align="absmiddle"/>
	<?php endif;?>
	</a>
	</li>
	<?php endforeach; ?>
...
<div class="side-meta">
  <ul>
    <li><span onclick="showhidediv('blogger')"><b>博主信息</b></span></li>
		...
		<img src="<?php echo $tpl_dir; ?>default/images/modify.gif" align="absmiddle" style="border:0"alt="修改我的状态"/></a></li>
