...
<h2 id="comments">引用：<input type="text" id="email" style="width:350px" value="<?php echo $blogurl;?>tb.php?sc=<?php echo $tbscode;?>&amp;id=<?php echo $logid;?>" /><a name="tb"></a></h2>
</div>
<?php endif; ?>	
<div class="comments-template">
...
?>
	...
	<br /><?php echo $value['content'];?><br /><div id="replycomm<?php echo $value['cid']; ?>"><?php echo $value['reply'];?></div>
	<?php if(ISLOGIN === true): ?>	
